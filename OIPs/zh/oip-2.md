...
生态系统的第四层就是金融应用程序，或 DApp 层。金融应用程序的 DApp 层将由 Olympus 协议所赋能。在这层中，我们预想了两大类 DApp：1、服务于金融产品出品人（投资经理和产品创建者）的 DApp，和 2、服务于金融产品消费者（消费者和投资人）的 DApp。Olympus 协议支持诸如钱包、投资组合跟踪应用、市场分析工具、用于创建和管理金融产品的投资管理应用、金融产品市场、金融产品交易所等等的金融科技应用。无论是既有应用还是构建新应用的开发者都可以通过使用我们的 APIs/SDKs 来集成 Olympus 协议，为他们的用户提供下一代金融产品和服务。
